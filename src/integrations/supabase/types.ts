...
export type Database = {
  ...
  public: {
    Tables: {
      cn_equipment_catalog: {
        Row: {
          altitude_m: number | null
          area_superficie_troca_evaporador_m2: number | null
          calor_rejeitado_condensador_kcalh: number | null
          calor_rejeitado_secundario_kcalh: number | null
          capacidade_frig_compressor_kcalh: number | null
          capacidade_frig_compressor_sec_kcalh: number | null
          capacidade_frig_reaquecimento_kcalh: number | null
          capacidade_frig_requisitada_kcalh: number | null
          carga_de_fluido_kg: number | null
          compressor: string | null
          compressor_codigo: string | null
          cond_circuits: number | null
          cond_fin_spacing_mm: number | null
          cond_length_mm: number | null
          cond_rows: number | null
          cond_tubes_per_row: number | null
          configuracao_eletrica: string | null
          cop_carnot_kk: number | null
          cop_carnot_secundario_kk: number | null
          cop_global_kw_kw: number | null
          cop_kw_kw: number | null
          cop_secundario_kw_kw: number | null
          corrente_elet_compressor_a: number | null
          corrente_elet_compressor_secundario_a: number | null
          corrente_elet_estimada_a: number | null
          corrente_elet_estimada_circuito_a: number | null
          corrente_elet_estimada_secundario_a: number | null
          corrente_elet_partida_a: number | null
          corrente_elet_partida_circuito_a: number | null
          corrente_elet_partida_secundario_a: number | null
          corrente_elet_ventiladores_a: number | null
          corrente_elet_ventiladores_secundario_a: number | null
          created_at: string
          created_by: string | null
          designacao_comercial_hp: string | null
          diametro_dreno: string | null
          diferenca_entalpia_kjkg: number | null
          esp_tubo_cond_mm: number | null
          esp_tubo_evap_mm: number | null
          evap_circuits: number | null
          evap_fin_spacing_mm: number | null
          evap_length_mm: number | null
          evap_rows: number | null
          evap_rows_2: number | null
          ...
          modelo_trocador_de_calor: string | null
          modelo_unico: string | null
          notes: string | null
          numero_fases: number | null
          odp_ar6: number | null
          potencia_elet_compressor_kw: number | null
          potencia_elet_compressor_secundario_kw: number | null
          potencia_elet_requerida_total_circuito_kw: number | null
          potencia_elet_total_kw: number | null
          potencia_elet_total_secundario_kw: number | null
          potencia_elet_ventilador_kw: number | null
          potencia_elet_ventilador_secundario_kw: number | null
          quantidade_agua_produzida_lh: number | null
          quantidade_drenos: number | null
          quantidade_reaquecimentos: number | null
          raw_json: Json
          reaq_circuits: number | null
          reaq_fin_spacing_mm: number | null
          reaq_length_mm: number | null
          reaq_tubes_per_row: number | null
          ...
          temperatura_camara_c: number | null
          temperatura_condensacao_c: number | null
          temperatura_condensacao_secundario_c: number | null
          temperatura_entrada_c: number | null
          temperatura_evaporacao_c: number | null
          temperatura_evaporacao_secundario_c: number | null
          temperatura_externa_c: number | null
          temperatura_saida_c: number | null
          ...
          tubo_cond_in: number | null
          tubo_cond_mm: number | null
          tubo_evap_in: number | null
          tubo_evap_mm: number | null
          umidade_camara_pct: number | null
          umidade_externa_pct: number | null
          updated_at: string
          vazao_massa_kgh: number | null
          vazao_massa_kgs: number | null
          vazao_ventilador_condensador_m3h: number | null
          vazao_ventilador_condensador_secundario_m3h: number | null
          vazao_ventilador_evaporador_m3h: number | null
          velocidade_linha_descarga_ms: number | null
          velocidade_linha_liquido_ms: number | null
          velocidade_linha_succao_ms: number | null
          ventilador_condensador: string | null
          ventilador_condensador_secundario: string | null
          ventilador_reaquecimento: string | null
          volume_interno_condensador_l: number | null
          volume_interno_evaporador_l: number | null
        }
        Insert: {
          altitude_m?: number | null
          area_superficie_troca_evaporador_m2?: number | null
