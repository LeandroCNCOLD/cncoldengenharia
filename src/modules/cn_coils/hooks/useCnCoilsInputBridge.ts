...
function isCondenserType(t: CnCoilsComponentType): boolean {
  return t === "condenser_air" || t === "condenser_shell_tube";
}

function isEvaporatorType(t: CnCoilsComponentType): boolean {
  return t === "evaporator_dx" || t === "evaporator_pumped";
}

export function useCnCoilsInputBridge(componentType: CnCoilsComponentType) {
