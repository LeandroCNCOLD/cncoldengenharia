...
function enrich(entry: RawGeometryEntry): CoilGeometryItem {
  ...
  // U base legado: preserva apenas valor explícito de catálogo/importação.
  // O motor calcula U por resistências em série e não usa default por tipo.
