// Tipos estritos do módulo CN Coils Simulator.
// Não traduzir nomes de propriedades — devem casar com chaves dos JSONs CN Coils.

export type CnCoilsComponentType =
  | "evaporator_dx"
  | "evaporator_pumped"
  | "condenser_air"
...
export interface CnCoilsPhysicalInputs {
  ...
  theta_L?: number;
  /** Amplitude de ondulação [m] — usado pela correlação Kim-Youn-Webb 1997. */
  A_w?: number;
}
