        ...
        <Row
          ...
          input={
            <select
              ...
              disabled={disabled}
              className="w-full rounded border border-slate-300 bg-white px-1.5 py-0.5 text-[10px] text-slate-900 focus:border-[#1E6FD9] focus:outline-none disabled:bg-slate-100"
            >
...
function NumberCell({
  ...
  return (
    <input
      ...
      className="w-full rounded border border-slate-300 bg-white px-1.5 py-0.5 text-right text-[10px] text-slate-900 focus:border-[#1E6FD9] focus:outline-none focus:ring-1 focus:ring-[#1E6FD9] disabled:cursor-not-allowed disabled:bg-slate-100 disabled:text-slate-400"
    />
  );
}
